...
public class KakaoPay {
	...
	public String kakaoPayReady(Funding request) {
        ...
        //params.add("approval_url", "http://i3a105.p.ssafy.io:3000/kakao/kakaoPaySuccess?nickname="+request.getNickname()+"&orderId="+Integer.toString(request.getFundingId())+"&amount="+Integer.toString(request.getMoney()));
